...
class StarNet2017_DeeperNetwork:
    ...
    def model(self, N_wavelength_pixels):
        ...
        maxpool_3 = GlobalAveragePooling1D()(maxpool_2)
        ...
        layer_3 = Dense(units=self.num_hidden[0], kernel_initializer=self.initializer, activation=self.activation,
                        kernel_regularizer=l2(self.l2), bias_regularizer=l2(self.l2))(maxpool_3)
        layer_3_drop = Dropout(0.3)(layer_3)
        ...
        layer_4_drop = Dropout(0.3)(layer_4)
